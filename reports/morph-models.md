...
> **Scanned at:** 2026-05-07T20:06:36.819119  
...
- **Java classes:** 2 on spec, 0 mixed, 0 legacy of 7 total
- **Example XMLs:** 0 on spec / 2 on `version="2.8"` / 2 total (+4 under legacy/)
...
**Targets BEAST 3 but missing `beast.base.spec.*` in namespace** (2):

- `examples/M3982.xml`
- `src/test/resources/examples/M3982.xml`
