...
> **Scanned at:** 2026-05-07T21:16:03.977395  
...
- **Java classes:** 1 on spec, 0 mixed, 16 legacy of 140 total
...
### CalcNodes — 6 legacy, 0 mixed (of 10 total)

**Legacy** (extends a legacy base — `ParametricDistribution`, `Prior`, or a `*Parameter` class):

- `beastlabs.evolution.likelihood.TraitedTreeLikelihood` — extends `TreeLikelihood`
- `beastlabs.evolution.sitemodel.SiteModelGI` — extends `SiteModelGI`
...
- `beastlabs.util.ReplaceSequenceInXML` — extends `ReplaceSequenceInXML`
